...
def connect(db_path: str,
    ...
    :param should_sanitize: whether every key and value inserted should be escaped to avoid
    confusion with token used in saving the data in the token-separated-value files
